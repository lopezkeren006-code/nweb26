...
use Dao\Products\Productss as DaoProducts;
use Views\Renderer;
...
class Products extends PublicController
{
  ...
  private function getParams(): void
  {
    ...
    $this->status = (isset($_GET["status"]) && in_array($_GET["status"], ['ACT', 'INA', 'EMP']))
      ? $_GET["status"]
      : $this->status;
    ...
    $this->orderBy = (isset($_GET["orderBy"]) && in_array($_GET["orderBy"], ["productId", "productName", "productPrice", "clear"]))
      ? $_GET["orderBy"]
      : $this->orderBy;
